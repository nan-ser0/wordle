...
class Header extends React.Component<any, any> {
  ...
  render() {
    return (
      <div className="Header flex items-center justify-between bg-gray w-full h-[84px] rounded-2xl px-12 py-4 dark:bg-d-gray transition duration-500">
